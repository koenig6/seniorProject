...
function workOrderSwap(workOrderNumber, ev){
    ...
    xmlhttp.open("GET","/jobClock/indexCopy.php?action=workOrderSwap&workOrderNumber="+workOrderNumber);
    xmlhttp.send();
...
function employeeAdd(employeeID, workOrderNumber, originWO, departmentId = false){
    ...
    xmlhttp.open("GET","/jobClock/indexCopy.php?action=summaryAddEmployee&workOrderNumber="+workOrderNumber+"&employeeID="+employeeID+"&originWO="+originWO+"&departmentID="+departmentId);
    xmlhttp.send();
...
function addToDept(departmentID){
    ...
    xmlhttp.open("GET","/jobClock/indexCopy.php?action=addToDept&employeeID="+employeeID+"&workOrderNumber="+workOrderNumber+"&departmentID="+departmentID);
    xmlhttp.send();
}
...
function viewDepts(transferId, targetId, originId, workOrderAdd){
    ...
    xmlhttp.open("GET","/jobClock/indexCopy.php?action=viewDept&transferId="+transferId+"&targetId="+targetId+"&originId="+originId+"&workOrderAdd="+workOrderAdd);
    xmlhttp.send();
}
...
function refreshSummary(){
    ...
    xmlhttp.open("GET","/jobClock/indexCopy.php?action=refreshSummary");
    xmlhttp.send();
}
