...
function viewEditDepartment(ajcPunchId, departmentID){
    ...
    xmlhttp.open("GET","/jobClock/index.php?action=editDepartmentList&departmentID="+departmentID);
    xmlhttp.send();
}
...
function editDepartment(ajcPunchId){
    ...
    xmlhttp.open("GET","/jobClock/index.php?action=updateJobDepartment&departmentID="+departmentID+"&ajcPunchId="+ajcPunchId);
    xmlhttp.send();
